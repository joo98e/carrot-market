...
export default function Enter() {
  ...
  return (
    <div>
      <h3 className="text-center text-2xl font-bold my-8">Enter to Carrot</h3>
      <div>
        <div>
          <h5 className="text-center">Enter using:</h5>
        ...
        <form className="p-8 flex flex-col">
          ...
          <button className="bg-orange-500 hover:bg-orange-600 mt-4 p-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-600 focus:ring-offset-2 shadow-sm text-sm rounded-md ">
        ...
        <div className="mt-3">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6 px-2">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md bg-white text-sm font-medium text-gray-500 shadow-md">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
