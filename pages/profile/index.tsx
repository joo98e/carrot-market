    ...
    <div className="py-10 px-4">
      ...
      <div className="mt-10 flex justify-around">
        <div className="flex flex-col items-center">
          <div className="cursor-pointer w-14 h-14 rounded-full text-white bg-orange-500 flex items-center justify-center">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <span className="text-sm mt-2 text-gray-700">판매내역</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="cursor-pointer w-14 h-14 rounded-full text-white bg-orange-500 flex items-center justify-center">
            <svg
