...
const Community: NextPage = () => {
  return (
    <div className="py-16 px-4 space-y-8">
      {[1, 2, 3, 4, 5, 6].map((_, i) => {
        return (
          <div className="flex flex-col cursor-pointer items-start" key={i}>
      ...
      <button className="fixed bottom-24 right-5 bg-orange-400 hover:bg-orange-500 cursor-pointer transition-colors rounded-full p-4 text-white shadow-xl">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
